...
def main(testcase):
    ...
    #testcase = 'withOctopus_CarbonData\\routine_penetration100SP53224_10020195_run0.xlsx'


    ###blank it out if you're using the run_batch.py

    # =====Model=====
    #specify a model to solve
    #model ='EVSchedule_V2G_NoEnergyDump'
    model = 'EVSchedule_V2G_NoEnergyDump_BinaryVals'
